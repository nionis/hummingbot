...
from hummingbot.connector.exchange.bidesk.bidesk_order_book_tracker import BideskOrderBookTracker
...
class BideskOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[BideskOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: BideskOrderBookTracker = BideskOrderBookTracker(cls.trading_pairs)
    ...
    def test_api_get_last_traded_prices(self):
        prices = self.ev_loop.run_until_complete(
            BideskAPIOrderBookDataSource.get_last_traded_prices(["BTC-USDT", "LTC-BTC"])
        )
