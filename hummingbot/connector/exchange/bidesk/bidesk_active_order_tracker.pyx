...
BideskOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class BideskActiveOrderTracker:
    def __init__(self,
                 active_asks: BideskOrderBookTrackingDictionary = None,
                 active_bids: BideskOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> BideskOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> BideskOrderBookTrackingDictionary:
